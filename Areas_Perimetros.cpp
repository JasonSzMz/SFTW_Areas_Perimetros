...
int main() //nuestra proceso principal
{
    system("cls");
    ...
    case 2:
        ...
        else
        {
            if (optionOp == 1)
            {
                printf("\nFormula: %c*r%c", 227, 253, "  Nota: Recuerda la medida del radio es la mitad de la medida del diametro");
                resOp = pi * (globalData * globalData);
            }
            else if (optionOp == 2)
            {
                printf("\nFormula: %c*d", 227, 253, "  Nota: Recuerda la medida del radio es la mitad de la medida del diametro");
